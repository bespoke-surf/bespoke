...
<div style="font-family: inherit; text-align: inherit">This is a generated email for the subscriber data erasure requested through Shopify for <strong>${dataGeneratedForEmail}</strong></div>
<div style="font-family: inherit; text-align: inherit"><br></div>
<div style="font-family: inherit; text-align: inherit">The following subscriber data has been removed:</div>
<ul>
<li style="text-align: inherit; font-family: inherit; font-weight: bold"><strong>First name, last name</strong></li>
<li style="text-align: inherit; font-family: inherit; font-weight: bold"><strong>Phone number</strong></li>
<li style="text-align: inherit; font-family: inherit; font-weight: bold"><strong>Full address</strong></li>
</ul>
<div style="font-family: inherit; text-align: inherit"><br></div>
<div style="font-family: inherit; text-align: inherit">You can re-request subscriber data through Shopify to check if the following data specified above has been removed.</div><div></div></div></td>
    </tr>
  </tbody>
