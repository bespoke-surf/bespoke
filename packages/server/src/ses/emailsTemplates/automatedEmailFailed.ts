export const automatedEmailFailedTemplate = ({
  planPage,
  emailSubject,
}: {
  planPage: string;
...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit">Hey there,<br>
<br>
Your automated email with the subject "${emailSubject}" was revoked from sending.</div>
<div style="font-family: inherit; text-align: inherit"><br>
This message was triggered right after we tried to send an email from one of your automation. Looks like you don't have enough email sends available to send emails. We recommend you upgrade your plan so that any future automated emails do not fail.</div><div></div></div></td>
      </tr>
    </tbody>
  </table><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="5f7f4e9c-b06c-46c2-b65a-8767b1c1db94">
      <tbody>
        <tr>
    ...
    </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="775ac611-d3e8-4867-b843-3d49221bc9a0" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
...
<div style="font-family: inherit; text-align: inherit"><span style="color: #000000; font-family: arial, helvetica, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: pre-wrap; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline">Bespoke</span></div>
<div style="font-family: inherit; text-align: inherit"><br></div>
<div style="font-family: inherit; text-align: inherit"><span style="color: #000000; font-family: arial, helvetica, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: pre-wrap; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline">PS: This is an automated message. You might get the same message again if another automated email was triggered and failed.</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
                                      </tr>
