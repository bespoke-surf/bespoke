...
export class Migrations1685184841744 implements MigrationInterface {
  name = 'Migrations1685184841744';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."item_category_type_enum" AS ENUM('SUBSCRIPTION', 'SHOP')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."item_category_type_enum_old" AS ENUM('SHOP')`,
    );
    await queryRunner.query(
